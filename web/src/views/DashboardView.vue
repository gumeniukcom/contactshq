  ...
  <div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
      ...
      <AppCard>
        <div class="flex items-center gap-4">
          <div
            class="h-12 w-12 rounded-lg bg-green-100 dark:bg-green-500/20 flex items-center justify-center"
          >
            <svg
      ...
      <AppCard>
        <div class="flex items-center gap-4">
          <div
            class="h-12 w-12 rounded-lg bg-purple-100 dark:bg-purple-500/20 flex items-center justify-center"
          >
            <svg
