<template>
  <div class="p-3 bg-gray-50 rounded border border-gray-200 space-y-2">
    ...
    <div v-if="credentials.length > 0">
      <label class="block text-xs text-gray-500 mb-1">Google Account</label>
      <select
        :value="modelValue.credential_id"
        class="block w-full rounded-md border-gray-300 text-sm px-3 py-2 border"
      ...
      <div v-if="modelValue.credential_id" class="mt-1 text-xs text-gray-500 flex items-center gap-1">
    ...
    <div v-else class="text-xs text-gray-500">
      ...
      <RouterLink to="/settings/google" class="text-indigo-500 hover:underline">
