<template>
  <div class="max-w-2xl">
    <div class="flex items-center justify-between mb-6">
      ...
      <AppButton variant="secondary" @click="handleTrigger" :loading="triggering"> Trigger Now </AppButton>
    </div>

    <AppCard>
      <div v-if="loadingPipeline" class="py-8 text-center text-muted-foreground">Loading...</div>
      <form v-else class="space-y-4" @submit.prevent="handleUpdate">
        ...
        <div class="flex justify-end gap-3 pt-4">
          <AppButton variant="secondary" @click="router.push({ name: 'pipeline-view', params: { id } })"
            >Cancel</AppButton
          >
